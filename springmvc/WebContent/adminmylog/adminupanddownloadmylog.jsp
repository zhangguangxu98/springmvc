...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/adminupanddownloadmylog.css">
                    ...
                    <tr>
                         ...
                         <td  class="exceltest">
                             <div class="exceltest1">
                                  <form action="adminuploadmylog.do" method="post" name="uploadform" enctype="multipart/form-data">
                                  <table id="exceltest3">
                                         <tr>
                                              <td class="exceltest4">
                                                  	上传日志:
                                  ...
                                  <form action="admindownloadmylog.do" method="post">
                                  <table id="exceltest6">
                                         <tr>
                                              <td class="exceltest7">
                                                  	下载日志:
