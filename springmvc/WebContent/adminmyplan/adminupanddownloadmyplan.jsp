...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/adminupanddownloadmyplan.css">
                    ...
                    <tr>
                         ...
                         <td  class="exceltest">
                             <div class="exceltest1">
                                  <form action="adminuploadmyplan.do" method="post" name="uploadform" enctype="multipart/form-data">
                                  <table id="exceltest3">
                                         <tr>
                                              <td class="exceltest4">
                                                  	上传计划:
                                  ...
                                  <form action="admindownloadmyplan.do" method="post">
                                  <table id="exceltest6">
                                         <tr>
                                              <td class="exceltest7">
                                                  	下载计划:
