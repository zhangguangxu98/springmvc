...
function firstPage(){  
    if(currentPage == 1){  
        ...
        submitForm("/springmvc/adminshowalluser.do?pageNum=1");  
        return true;  
    }  
}  
...
function nextPage(){  
	if(currentPage == totalPage){  
        ...
        submitForm("/springmvc/adminshowalluser.do?pageNum=" + (currentPage+1));  
        return true;  
    }  
}  
...
function lastPage(){  
    if(currentPage == totalPage){  
        ...
        submitForm("/springmvc/adminshowalluser.do?pageNum="+totalPage);  
        return true;  
    }  
}
