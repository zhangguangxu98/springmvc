...
function firstPage(){  
    if(currentPage == 1){  
        ...
        submitForm("/springmvc/adminshowalllotteryresult.do?pageNum=1");  
        return true;  
    }  
}  
...
function nextPage(){  
	if(currentPage == totalPage){  
        ...
        submitForm("/springmvc/adminshowalllotteryresult.do?pageNum=" + (currentPage+1));  
        return true;  
    }  
}  
...
function lastPage(){  
    if(currentPage == totalPage){  
        ...
        submitForm("/springmvc/adminshowalllotteryresult.do?pageNum="+totalPage);  
        return true;  
    }  
}
